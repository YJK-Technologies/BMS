...
const AddBoothList = () => {
    ...
    const uploadPatientPermission = permissions
        .filter(permission => permission.screen_type === 'AddBoothWise')
    ...
    reader.onload = (e) => {
        try {
            ...
            const expectedHeaders = [
                "Name", "Address", "Age", "Qualification", "Caste", "Posting",
                "Mobile No", "DOJ Party", "Member ID", "Voter Serial No", "Aadhar No", "State",
            ...
            const newData = rows
                ...
                .map((row, index) => ({
                    ...
                    dojparty: typeof row[headerIndexMap["DOJ Party"]] === 'number'
                        ? excelDateToJSDate(row[headerIndexMap["DOJ Party"]])
                        : row[headerIndexMap["DOJ Party"]] || '',
            ...
            <div className="shadow-lg p-0 bg-body-tertiary rounded-3 mb-2 mt-2 ">
                <div className="d-flex justify-content-between">
                    <div className="d-flex justify-content-start">
                        <h1 className="me-5 ms-4 fs-2 mt-1">Add Booth Wise List</h1>
                    </div>
