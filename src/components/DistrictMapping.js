...
function DistrictMapping() {
    ...
    const [Booth_no, setboothno] = useState('');
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const response = await fetch(`${config.apiBaseUrl}/DistrictMappingSearchCretria`, {
                ...
                body: JSON.stringify({ user_code:userCode, Booth_no,state, district, constituency, status, user:sessionStorage.getItem("selectedUserCode"), })
            });
            if (response.ok) {
                ...
                <div className="d-flex justify-content-between">
                    ...
                    <div className="button-container">
                        ...
                        <div className="d-none d-md-flex justify-content-end">
                            {['add', 'all permission'].some(permission => DistrictMappingPermission.includes(permission)) && (
                                <printbutton className="purbut me-2" onClick={handleNavigatesToForm} title="Add District Mapping">
